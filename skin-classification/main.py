...
top_model_weights_path = '/imatge/aromero/work/image-classification/MIDDLE_Skin_Classification/weights/bottleneck_model_weights.h5'   # this is the best performing model before fine tuning
...
# checkpoint
checkpoint_path="/imatge/aromero/work/image-classification/MIDDLE_Skin_Classification/weights/weights-improvement-{epoch:02d}-{val_acc:.2f}.hdf5"
