...
X_nz_test, y_nz_test = loadImageData(path_nz_test, 0)   # Test Benign
X_mm_train, y_mm_train = loadImageData(path_mm_train, 1)    # Train Malignant
X_mm_test, y_mm_test = loadImageData(path_mm_test, 1)   # Test Malignant
...
#X_train = X_train[:5000]   Idk why this is done!
